...
const serverPermissionMap: Partial<Record<string, SystemPermission[]>> = {
  ...
  'sales.sale.create': ['sales_access', 'create_sales_invoice'],
  'sales.sale.create_on_behalf': ['sales_access', 'create_sales_invoice'],
  'sales.invoice.read_own': ['sales_access', 'view_own_invoices'],
  'sales.invoice.read_all': ['sales_access', 'view_team_invoices'],
  'sales.invoice.supervisor_approve': ['sales_access', 'view_team_invoices'],
  'sales.payment.record': ['sales_access', 'view_own_invoices'],
  'sales.payment.review': ['view_sales_financial_queue', 'review_invoice_financial_confirmation'],
