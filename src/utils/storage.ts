...
export const DEFAULT_USERS: User[] = [
  {
    ...
    costCenterId: 'cc_hq',
    allowedCostCenterIds: ['cc_hq', 'cc_saadatabad', 'cc_poonak', 'cc_mokhberi1', 'cc_mokhberi2', 'cc_azadi', 'cc_fechar'],
    isActive: true,
    password: '123456',
  ...
  },
  {
    ...
    allowedCostCenterIds: ['cc_saadatabad', 'cc_poonak', 'cc_mokhberi1', 'cc_mokhberi2'],
    password: '123456',
    isActive: true,
