...
| عملیات فعلی Lead، Sales Queue، Assignment و Call Log | `docs/domains/sales/current-lead-operations.md` با شواهد migration/service/test | `docs/domains/sales/current-lead-operations.md` | Sales Domain Owner | `ACTIVE` | module catalog, current system, data model, API status, security |
