...
| معماری آینده platform/backend | `docs/architecture/future-platform.md` | `docs/architecture/future-platform.md` | Architecture Owner | `ACTIVE (DRAFT)` | future API contract, approved sales design |
